  ...
  <div class="row">
    <div class="col-sm-8" style="padding:20px; border:1px solid #F0F0F0;">
	    <form method="post">
			...
			<div class="form-group">
                 <input type="tel" class="form-control" pattern="[0-9]{0-9}[0-9]{0-9}"  name="phone" placeholder="Phone(optinal) EX 07...."/>
            </div>
			<div class="form-group">
    ...
    <div class="col-sm-4" style="padding:30px;">
	   <div class="form-group">
           <i class="fa fa-phone" aria-hidden="true"></i>&nbsp;<b>0701409293</b><br><br>
		   <i class="fa fa-phone" aria-hidden="true"></i>&nbsp;<b>0741669569</b><br><br>
		   <i class="fa fa-phone" aria-hidden="true"></i>&nbsp;<b>0746979370</b><br><br>
		   <i class="fa fa-phone" aria-hidden="true"></i>&nbsp;<b>0793554453</b><br><br>
