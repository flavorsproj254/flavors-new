	       ...
	       <div class="tab-pane fade show active" id="register" role="tabpanel" aria-labelledby="home-tab">
			    ...
			    <form action="" method="post" enctype="multipart/form-data">
                     ...
                     <div class="form-group">
                         ...
                         <input type="tel" class="form-control" pattern="[0-9]{0-9}[0-9]{0-9}" value="<?php if(isset($mob)) { echo $mob;}?>"id="mob" placeholder="Ex 0712345678" name="mob" required/>
                     </div>
	                 <div class="form-group">
                          <label for="phone">Phone:</label>
                          <input type="tel" class="form-control" pattern="[0-9]{0-9}[0-9]{0-9}" id="phone" value="<?php if(isset($phone)) { echo $phone;}?>" placeholder="Ex 0712345678" name="phone" required>
                     </div>
	                 <div class="form-group">
