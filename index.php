...
<nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
    ...
    <a class="navbar-brand" href="index.php"><span style="color:green;font-family: 'Permanent Marker', cursive;">Flavors</span></a>
    <?php
	if(!empty($cust_id))
	{
	?>
...
<div id="demo" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="img/coffee_foam_beverage_cup_saucer_creative_continents_84944_1920x1080 (1).jpg" alt="meru" class="d-block w-100">
    ...
    <div class="carousel-item">
      <img src="img/coffee_cup_saucer_grains_foam_73571_1920x1080.jpg" alt="Nairobi" class="d-block w-100">
      <div class="carousel-caption">
        <h3><span style="color:green;">Nairobi</h3>
        <p><span style="color:green;">Welcome to Nairobi!</p>
      </div>   
    </div>
    <div class="carousel-item">
      <img src="img/coffee_foam_beverage_cup_saucer_creative_continents_84944_1920x1080 (1).jpg" alt="Naivasha" class="d-block w-100">
      <div class="carousel-caption">
        <h3>Naivasha</h3>
        <p>Get ready to enjoy the Big Apple at Vasha!</p>
      </div>   
    </div>
  </div>
...
<div class="container-fluid">
  <div class="row">
    ...
    <div class="col-sm-6">
	<div class="container-fluid">
	 <img src="img/istockphoto-516324258-612x612.jpg" height="450px" width="100%">
	</div>
	 <div class="container">
	 <p style="font-family: 'Lobster', cursive; font-weight:light;  font-size:25px;">Flavors is the best place to be whereby we offer quality food at an affordable price.Our staff are well trained and qualified offering the best food service ever.Our objective is to ensure that we satisfy our customers.We offer after sale services such as free delivery to areas near our hotels/restaurant.</p> <p style="font-family: 'Lobster', cursive; font-weight:light;  font-size:25px;">Our customers have good acces to the hotel foods through login to the accounts created . Flavors hotel has a motive of making sure that everyone has a good meal by ensuring that we reopen several hotels in various areas. Flavors hotel is the only place where you will find vendors offering food to taste before you actually pay for the food that you had ordred</p>
	 </div>
	...
	<?php
	  ...
	  <div class="container-fluid">
	     <div class="row" style="padding:10px; ">
		      <div class="col-sm-"4><img src="<?php echo $hotel_logo; ?>" class="rounded-circle" height="50px" width="50px" alt="Cinque Terre"></div>
		      <div class="col-sm-5">
		 ...
		 <div class="col-sm-3"><i  style="font-size:20px;" class="fas fa-shillig-sign"></i>&nbsp;<span style="color:green; font-size:25px;"><?php echo $res['cost']; ?></span></div>
		 <form method="post">
	  ...
	  <div class="container-fluid">
		 ...
		 <span><li><?php echo "Ksh ".$res['cost']; ?>&nbsp;for 1</li></span>
		 <span><li>Up To 30 Minutes</li></span>
		 </div>
...
<div class="container-fluid">
     <div class="row"><!--main row-->
	                  ...
	                  <?php
	                        ...
	                        tbfood on tblvendor.fldvendor_id=tbfood.fldvendor_id where tbfood.food_id='$food_id'");
	                             while($res=mysqli_fetch_assoc($query))
		                            ...
		                            <!--shilling-->      <div class="col-sm-3"><i  style="font-size:20px;" class="fas fa-shilling-sign"></i>&nbsp;<span style="color:green; font-size:25px;"><?php echo $res['cost']; ?></span></div>
									                   <form method="post">
		                         <!--add to cart-->    <div class="col-sm-2" style="text-align:left;padding:10px; font-size:25px;"><button type="submit"  name="addtocart" value="<?php echo $res['food_id'];?>"><span style="color:green;"><i class="fa fa-shopping-cart" aria-hidden="true"></i></span></button></div>
		                           ...
		                           <!--food Image-->     <div class="col-sm-12"><img src="<?php echo $food_pic; ?>" class="rounded" height="250px" width="100%" alt="Cinque Terre"></div>
		                               ...
		                               <!--cuisine-->          <span><li><?php echo $res['cuisines']; ?></li></span>
		                                ...
		                                <!--deliverytime-->    <span><li>Up To 30 Minutes</li></span>
		                                                 </div>
	   ...
	   <div class="col-sm-6">
	        <div class="container-fluid">
	             <img src="img/pastaveg_640x480.jpg" height="500px" width="100%"><!--image-->
	        </div>
	        <div class="container">
	        <!--paragraph content--> 
	             <p style="font-family: 'Lobster', cursive; font-weight:light; font-size:25px;">Say hello to flavors food ordering site, and say goodbye to saying hello into a phone .<br>Food brings people together on many different levels.It's nourishments of the soul and body.It's truly love.<br ></p>
	        </div>
	  </div>
