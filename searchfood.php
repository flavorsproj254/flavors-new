    ...
    <div class="collapse navbar-collapse" id="navbarResponsive">
      ...
      <ul class="navbar-nav ml-auto">
		  ...
		  <?php
			...
			?>
			<li class="nav-item">
			<a href="form/cart.php" class="nav-link"><form method="post"><span style=" color:blue; font-size:30px;"><i class="fa fa-shopping-cart" aria-hidden="true"><span style="color:green;" id="cart"  class="badge badge-light"><?php if(isset($re)) { echo $re; }?></span></i></span></form></a>
			</li>
			<li class="nav-item">
...
<div class="row">
   ...
   <?php
	  ...
	  <div class="container-fluid">
		 ...
		 <div class="col-sm-2"><i class="fas fa-shilling-sign"></i><span style="color:green; font-size:20px;"> <?php echo $res['cost']; ?></span></div>
		 <form method="post">
